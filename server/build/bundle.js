...
exports.default = [_extends({}, _App2.default, {
    routes: [_extends({}, _HomePage2.default, { /// destructures component object, allowing access to loadData()
        path: '/',
        exact: true
...
app.use(_express2.default.static('public')); // Express to make 'public' directory available to outside world
...
// Allows us to create the fetchAdmins action
...
var AdminsListPage = function (_Component) {
    ...
    _createClass(AdminsListPage, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            // tries to fetch admins on client-side render
            this.props.fetchAdmins();
        }
    }, {
        key: 'renderAdmins',
        value: function renderAdmins() {
            return this.props.users.map(function (admin) {
                // maps over the returned list of admins and
                return _react2.default.createElement(
                    'li',
                    { key: admin.id },
                    admin.name
...
function loadData(store) {
    // manual call to fetchAdmins done as part of server-side rendering
